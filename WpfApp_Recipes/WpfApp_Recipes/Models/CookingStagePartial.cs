...
{
    /// <summary>
    /// Это частичка (partial) основного класса CookingStage. 
    /// Заметьте, что названия классов совпадают = CookingStage, а каждый класс при этом помечен как публичный (public) и частичный (partial).
